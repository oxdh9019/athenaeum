...
- [2. 核心概念定义](#2-核心概念定义)
- [3. 系统架构](#3-系统架构)
- [4. WorldX 世界引擎](#4-worldx-世界引擎)
- [5. 模块化架构设计](#5-模块化架构设计)
- [6. Zyantine 人格引擎](#6-zyantine-人格引擎)
- [6. Agent Mesh（角色交互网络）](#6-agent-mesh角色交互网络)
- [7. 环境系统](#7-环境系统)
- [8. 用户交互](#8-用户交互)
- [8. 世界生成（AI 辅助）](#8-世界生成ai-辅助)
- [8.3 角色生成系统](#83-角色生成系统)
- [9. 技术实现](#9-技术实现)
- [10. 数据模型](#10-数据模型)
- [11. 开发阶段](#11-开发阶段)
- [12. 风险与对策](#12-风险与对策)
...
> 注：第 6、8 节存在历史遗留的重复编号，未做强制重编号以保持正文锚点稳定。
> 第 8.x 子节属"世界生成"子模块。
